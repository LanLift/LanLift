...
class ServerProfileStore {
  ...
  getConnectionCredentials(id) {
    ...
    return { ...this.publicProfile(profile), credential: this.decrypt(profile.encryptedCredential) };
  }
  ...
  async saveProfile(input) {
    ...
    const profile = {
      ...
      turnUrls,
      username,
      encryptedCredential: credentialInput ? this.encrypt(credentialInput) : (existing?.encryptedCredential || null),
